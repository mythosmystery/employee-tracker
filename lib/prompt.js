        ...
        return inquirer.prompt([
            {
                ...
                message: "Menu:",
                name: "menu",
                choices: ["See all employees", "Add new employee", "Update employee", "Delete employee", "Back"]
            }
        ]);
    }
        ...
        return inquirer.prompt([
            {
                ...
                message: "Menu:",
                name: "menu",
                choices: ["See all departments", 'Add new department', "See department budget", "Delete department", "Back"]
            }
        ]);
    }
    static roleMenu() {
        return inquirer.prompt([
            {
                ...
                message: "Menu:",
                name: "menu",
                choices: ["See all roles", "Add new role", "Delete role", "Back"]
            }
        ]);
    }

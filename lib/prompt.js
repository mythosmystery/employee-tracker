        ...
        return inquirer.prompt([
            {
                ...
                message: "Menu:",
                name: "menu",
                choices: ["See all employees", "Add new employee", "Update employee role", "Update employee manager", "Delete employee", "Seed database", "Exit"]
            }
        ]);
    }
        ...
        return inquirer.prompt([
            {
                ...
                message: "Menu:",
                name: "menu",
                choices: ["See all departments", 'Add new department', "Delete department", "Seed database", "Exit"]
            }
        ]);
    }
    static roleMenu() {
        return inquirer.prompt([
            {
                ...
                message: "Menu:",
                name: "menu",
                choices: ["See all roles", "Add new role", "Delete role", "Seed database", "Exit"]
            }
        ]);
    }
    static getEmployeeToUpdate() {
        return inquirer.prompt([
            {
                type: "number",
                message: "Enter the employee ID of the employee to update",
                name: "updateID"
            }
        ]);
    }
